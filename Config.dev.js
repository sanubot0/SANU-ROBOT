{
  ...
  "credentials": {
    "gmailAccount": {
      "email": "cliffbotbeluga@gmail.com",
  ...
  "serverUptime": {
    ...
    "socket": {
      "enable": true,
      "channelName": "uptime",
      "verifyToken": "AJ3mQqe9wrL8sF5NAwJuSteH",
			"url": "${process.env.DevURL}",
			"url2": "https://${process.env.REPL_SLUG}.${process.env.REPL_OWNER"
		}
  },
  "autoRestart": {
    "time": 3600000,
  ...
  "autoUptime": {
    ...
    "url": "${process.env.DevURL}.sisko.replit.dev/",
		"url2": "https://${process.env.REPL_SLUG}.${process.env.REPL_OWNER",
